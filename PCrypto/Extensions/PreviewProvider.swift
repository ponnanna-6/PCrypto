...
class DeveloperPreview {
    ...
    let stat1 = StatisticsModel(title: "MArket cap", value: "$2.5tr", percentageChange: 0.7)
    
    let stat2 = StatisticsModel(title: "MArket cap", value: "$2.5tr", percentageChange: -7)
